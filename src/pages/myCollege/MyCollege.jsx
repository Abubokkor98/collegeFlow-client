...
export default function MyCollege() {
  ...
  const handleAddReview = async (e) => {
    ...
    if (admissions.length === 0) {
      toast.error("You need to apply to a college first");
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-indigo-900 p-8">
      <div className="container mx-auto">
        ...
        {/* Admission Details */}
        <section className="bg-white/5 backdrop-blur-xl p-6 rounded-3xl shadow-lg mb-8">
          <h2 className="text-2xl font-bold text-white mb-4">Admission Details</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-gray-300">
            <p>
              <span className="font-semibold text-white">Name:</span> {admission.candidate_name}
            </p>
            <p>
              <span className="font-semibold text-white">Email:</span> {admission.candidate_email}
            </p>
            <p>
              <span className="font-semibold text-white">Subject:</span> {admission.subject}
            </p>
            <p>
        ...
        {/* Add Review */}
        <section className="bg-white/10 backdrop-blur-xl p-6 rounded-3xl shadow-lg mb-8">
